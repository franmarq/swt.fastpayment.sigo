...
proc contents data=FastPaym.solicitudes_mov_220221 varnum; run;

/*
#	Variable	Type	Len	Format
1	rif	Char	10	$10.
2	solicitud	Char	10	$10.
3	estatus	Char	40	$40.
4	fecha_inicio	Num	8	DATE9.
5	fecha_fin	Num	8	DATE9.
6	Hora_Inicio	Char	20	$20.
7	Hora_fin	Char	20	$20.
8	usuario	Char	20	$20.
*/
...
/*variables discretas*/
proc freq data=FastPaym.solicitudes_mov_220221 order=freq;
tables 	estatus ;
run;
